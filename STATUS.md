...
- **PR-D1R (compose startup contract) — IN REVIEW, 2026-09-20:** `docker/docker-compose.yml` api servisi
  ...
  öncesi api env'inde bu dört anahtar **yoktu** (api container hiç ayağa kalkamıyordu) ve root `.env`
...
- **İnceleme bulgusu ve düzeltmesi (2026-09-20):** compose'un `:-` boş varsayılanı
  ...
  kalır. 7 senaryo regresyon testleriyle kilitlendi: development boş/blank/eksik anahtar → PASS +
